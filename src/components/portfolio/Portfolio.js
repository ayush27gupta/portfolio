        ...
        <div className="container_portfolio" id="portfolio">
          ...
          <div className="content_portfolio">
            <div className="project_card">
              <a
                href="https://todojs-ash.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="project_card">
              <a
                href="https://clockrem.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="project_card">
              <a
                href="https://textutils12.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="project_card">
              <a
                href="https://ayush27gupta.github.io/CSS6/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="project_card">
              <a
                href="https://ayush27gupta.github.io/CSS5/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="project_card">
              <a
                href="https://ash-blog.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="img_proj img_proj6"></div>
              </a>
            </div>
          </div>
        </div>
